...
(function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            //return sprintf(' %s 到 %s 共 %s 条', pageFrom, pageTo, totalRows);
            return '';
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push(
           // sprintf('<div class=" pull-right %s-%s pagination-detail">', bs.pullClass, this.options.paginationDetailHAlign),
            sprintf('<div class=" pull-right pagination-detail">', bs.pullClass, this.options.paginationDetailHAlign),
